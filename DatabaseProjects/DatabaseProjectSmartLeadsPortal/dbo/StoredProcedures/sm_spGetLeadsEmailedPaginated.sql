CREATE PROCEDURE [dbo].[sm_spGetLeadsEmailedPaginated]
...
BEGIN
 SET NOCOUNT ON;
	SELECT sal.FirstName + ' ' + sal.LastName AS FullName, sal.CompanyName, sal.Email, sal.PhoneNumber, sal.CreatedAt AS ExportedDate, ses.SequenceNumber, ses.ReplyTime, ses.SentTime, sal.[Location] AS Country
