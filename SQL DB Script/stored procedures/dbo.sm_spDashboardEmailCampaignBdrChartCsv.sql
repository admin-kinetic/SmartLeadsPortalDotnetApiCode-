CREATE OR ALTER PROCEDURE [dbo].[sm_spDashboardEmailCampaignBdrChartCsv]
@startDate DATETIME, 
@endDate DATETIME,
@bdr VARCHAR(500),
...
BEGIN   
	SET NOCOUNT ON;
	SELECT sla.FirstName, sla.LastName, sla.Email, sla.CompanyName, sla.[Location] AS Country, sla.CreatedAt AS DateCreated, ses.SentTime AS DateEmailed,
