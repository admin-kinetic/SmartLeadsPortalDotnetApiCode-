...
namespace Common.Models.Webhooks;

public class LeadCategoryUpdatePayload
{
    public string? campaign_status { get; set; }
    public int? client_id { get; set; }
    [JsonConverter(typeof(DoubleFromStringOrNumberConverter))]
    public double? lead_id { get; set; }
...
public class Category
{
    ...
    public string? sentiment_type { get; set; }
}
...
public class LastReply
{
    ...
    [JsonConverter(typeof(DateTimeFromStringConverter))]
    public DateTime? time { get; set; }
    public object email_body { get; set; }
    public List<object> cc_emails { get; set; }
}
